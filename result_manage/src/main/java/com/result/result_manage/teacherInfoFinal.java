...
public class teacherInfoFinal {
    teacherInfoFinal(int tid)
    {
...
//        int tid = 15311790;
        ...
        Label l_3 = new Label("Teacher Personal Details : ");
        ...
        btn_3.setOnAction(e->{
            BtnAction(gps_3,tid,gpp1_3,gpp2_3);

        });
        gps_3.addRow(0,gpp1_3,gpp2_3);
        root.getChildren().add(gps_3);
        btn_3.setFont(Font.font("Aerial",FontWeight.BOLD,FontPosture.REGULAR,15));


        root.getChildren().addAll(rc_3,l_3,btn_3,img_3,cr1_3,cr2_3,cr3_3,cr4_3,cr5_3,cr6_3);
    ...
    public void BtnAction(GridPane gps_3, int tid,GridPane gpp1_3,GridPane gpp2_3) {
        String fn = null;
        String ln = null;
        String eml = null;
        String cid1 = null;
        ...
        String q_3 = "select * from teacher_info where t_id =" + tid + ";";
        ...
        try {
            ...
            mbno = new BigInteger(rs_3.getString(4));
            cid1 = rs_3.getString(6);
            cid2 = rs_3.getString(7);
            cid3 = rs_3.getString(8);
            ...
            Label t11 = new Label("Teacher id : ");
            t11.setFont(Font.font("Cursive", FontWeight.NORMAL, FontPosture.REGULAR, 15));
            String ro_3 = new String(String.valueOf(tid));
